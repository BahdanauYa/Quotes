...
namespace Quotes.Tools
{
    ...
    public class TextBoxInputBehavior : Behavior<TextBox>
    {
        ...
        public static readonly DependencyProperty RegularExpressionProperty =
            DependencyProperty.Register("RegularExpression", typeof(string), typeof(TextBoxInputBehavior),
        ...
        public static readonly DependencyProperty MaxLengthProperty =
            DependencyProperty.Register("MaxLength", typeof(int), typeof(TextBoxInputBehavior),
        ...
        public static readonly DependencyProperty SpacesAllowedProperty =
            DependencyProperty.Register("SpacesAllowed", typeof(bool), typeof(TextBoxInputBehavior),
                new FrameworkPropertyMetadata(true));

        public bool SpacesAllowed
        {
            get => (bool) GetValue(SpacesAllowedProperty);
            set => SetValue(SpacesAllowedProperty, value);
        }

        public static readonly DependencyProperty EmptyValueProperty =
            DependencyProperty.Register("EmptyValue", typeof(string), typeof(TextBoxInputBehavior), null);
        ...
        private void PastingHandler(object sender, DataObjectPastingEventArgs e)
        {
            if (e.DataObject.GetDataPresent(DataFormats.Text))
            {
                ...
                var fullText = AssociatedObject.Text + text;

                if (!ValidateText(fullText))
                    e.CancelCommand();
            }
            else
                e.CancelCommand();
